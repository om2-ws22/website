...
Stellen Sie die Ergebnisse jeweils in einer Pivot-Übersicht dar (nennen Sie die Reiter wie die Aufgabe: 4a, 4b, ...) und **interpretieren** Sie die statistischen Kennzahlen (Minimum, ..., Standardabweichung) beispielhaft anhand von einer Facebook-Kennzahlen (bspw. Seiteninteraktion) mit Hilfe von Kommentaren unterhalb der Tabellen:
